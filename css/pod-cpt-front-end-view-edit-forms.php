...
class Kaya_View_Edit_Cpt_Form_Widget extends WP_Widget{
	public function __construct(){
		parent::__construct('cpt-front-end-view-edit-forms',__('Pods - CPT Post Front End list View, Edit & Delete Form','ppd'),
			array('description' => __('Use this widget to add  cpt post Front End as list view, edit and delete pods post','ppd'))
		);
	}
